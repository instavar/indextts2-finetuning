#!/usr/bin/env python3
"""Exercise malformed and overlapping requests against a live speech server."""
...
def main() -> int:
    ...
    report = {
        ...
        "boundary": (
            ...
            "They do not establish ingress security, load capacity, cancellation, GPU OOM recovery, or production readiness."
        ),
    }
